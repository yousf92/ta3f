...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function setupGeminiFeatures() {
        ...
        salafStoryBtn.addEventListener('click', async () => {
            ...
            let salafPrompt = `بصفتك ناصح  امين وفاهم على منهج السلف الصالح سولف لي عن واحد من السلف وكيف كان خوفه من الله وتقواه وكيف كان يجاهد نفسه عشان يترك المعاصي وكيف لقى لذة الايمان الحقيقية واربط لي هالكلام بموضوع التعافي من الادمان وكيف ان لذة الطاعة احلى وابقى من لذة المعصية الزايلة كل مرة عطني قصة جديدة وعشوائية من حياة الصحابة او التابعين او الصالحين ولا تكرر القصص ابدا لا تخرج عن المنهج السلفي في سرد القصص تكلم باللهجة السعودية العامية وخلك طبيعي كانك تسولف مع خويك ولا تستخدم اي علامات ترقيم او تشكيل نهائيا وعطني كلام طويل ومفصل مو مختصر`;
            if (lastSalafStory) {
